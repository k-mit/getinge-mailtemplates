                            ...
                            <table align="<?=$tc3==1?"left":$tc3==2?"center":"right"?>" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="mcnTextContent" valign="top" style="padding:0; text-align: left" width="174">
                                        ...
                                        <div style="color:#787878; font-size:12px; padding-top: 9px;font-weight: bold;">2015.06.02 | Exhibition</div>
                                        ...
                                        <a href="http://getingegroup.com" target="_blank" style="color: #0046ad; text-decoration: none; padding: 15px 20px; border: 1px solid #0046ad; font-weight: 200; text-align: center;">Read more</a><br><br>
                                    </td>
                                </tr>
                                </tbody>
                            </table>

    ...
    <style type="text/css">
        ...
        */
        ...
        @media only screen and (max-width: 480px) {
            table.showableTable {
                display: block!important;
                font-size: 14px!important; max-height: none!important; line-height: 125%!important;
                padding-top: 18px;


            }
            table.showableTable a {
                color:#0c5da9; text-decoration: none; display:inline-block; padding: 15px 20px; border: 1px solid #0c5da9; font-weight: 200; text-align:center;
            }
            table.hideableTable {
                display: none!important;
            }
            ...
            .mcnCaptionBlock .mcnTextContent {
                padding-left: 0!important;
                padding-right: 0!important;
            }
            .twocoltable .mcnBoxedTextContentColumn {
                padding-left: 0!important;
                padding-right: 0!important;
            }
            ...
            .lowerColumnContainer .lowerRightColumnContainer {
            ...
            .footerContent .mcnTextContent {
                padding-left: 0!important;
                padding-top: 18px;
            }
        }
        .eor tr:nth-child(even) td {
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                    ...
                    <tr>
                        <td align="center" valign="top" id="templateBody" bgcolor="#ffffff">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top" id="templateHeader" class="bodyContainer">
                                        <!-- BEGIN HERO 1 COLUMN // -->
                                ...
                                <tr>
                                    <!-- BEGIN 3 COLUMNS // -->
                                    <td align="center" valign="top" id="threeColumns">
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td align="left" style="text-align:center; display:inline-block; padding: 0 0 0 18px;" valign="top">
                                                    <!-- BEGIN INDIVIDUAL COLUMNS // -->
                                                    <!--[if gte mso 9]>
                                                    <table align="left" border="0" cellspacing="0" cellpadding="0" style="width:582px;" width="582">
                                                        <tr>
                                                            <td align="left" valign="top" style="width:190px;" width="190">
                                                    <![endif]-->
                                                    ...
                                                    <td align="center" valign="top" style="width:190px;" width="190">
                                                    <![endif]-->
                                                    <div style="display:inline-block; vertical-align:top; width:190px;" class="upperColumnWidth">
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="threeColumnsContainer">
                                                            <tr>
                                                    ...
                                                    <td align="right" valign="top" style="width:190px;" width="190">
                                                    <![endif]-->
                                                    <div style="display:inline-block; vertical-align:top; width:190px;" class="upperColumnWidth">
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="threeColumnsContainer">
                                                            <tr>
                                ...
                                <tr>
                                    <!-- BEGIN 3 COLUMNS GRAY // -->
                                    <td align="center" valign="top" id="threeColumnsGray">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"  width="100%">
                                            <tr>
                                                <td align="left" style="text-align:center; display:inline-block; padding:0 9px 0 9px" valign="top">
                                                    <!-- BEGIN INDIVIDUAL COLUMNS // -->
                                                    <!--[if gte mso 9]>
                                                    <table align="left" border="0" cellspacing="0" cellpadding="0" style="width:600px;" width="582">
                                                        <tr>
                                                                            ...
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="false">
                                                                                <tbody><tr>
                                                                                    <td class="mcnCaptionBottomImageContent" align="left" valign="top" style="padding:0 0px 9px 0px;">
                                                                                        ...
                                                                                        <img alt="" src="https://k-mit.se/dev/getinge/mail/2part-img1.png" width="271" style="max-width:460px;" class="mcnImage">
                                                                            ...
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="false">
                                                                                <tbody><tr>
                                                                                    <td class="mcnCaptionBottomImageContent" align="left" valign="top" style="padding:0 0px 9px 0px;">
                                                                                        ...
                                                                                        <img alt="" src="https://k-mit.se/dev/getinge/mail/2part-img2.png" width="271" style="max-width:460px;" class="mcnImage">

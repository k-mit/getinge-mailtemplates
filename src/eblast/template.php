...
<center>
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
        <tr>
            <td align="center" valign="top" id="bodyCell" bgcolor="#f2f2f2" style="background-color:#f2f2f2">
                <!--[if gte mso 9]>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top" id="templateHeader" class="bodyContainer">
                                        <!-- BEGIN HERO 1 COLUMN // -->
                                        <?php include("parts/hero1col.php"); ?>
                                        <!-- // END HERO 1 COLUMN -->
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td valign="top" class="bodyContainer">
                                        <?php include("parts/twocol-table.php"); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <!-- BEGIN 3 COLUMNS // -->
                                    <?php include("parts/threecol/wrapper.php"); ?>
                                    <!-- // END 3 COLUMNS -->
                                </tr>
                                <tr>
                                    <!-- BEGIN 3 COLUMNS GRAY // -->
                                    <?php include("parts/threecol-gray/wrapper.php"); ?>
                                    <!-- // END 3 COLUMNS GRAY-->

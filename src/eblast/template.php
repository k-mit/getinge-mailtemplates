...
<head>
    ...
    <style type="text/css">
        ...
        */
        ...
        /*
        @tab Upper Columns
        @section upper left column style
        ...
        */
        ...
        /*
        @tab Upper Columns
        @section upper left column link
        ...
        */
        ...
        /*
        @tab Upper Columns
        @section upper center column style
        ...
        */
        ...
        /*
        @tab Upper Columns
        @section upper center column link
        ...
        */
        ...
        /*
        @tab Upper Columns
        @section upper right column style
        ...
        */
        ...
        /*
        @tab Upper Columns
        @section upper right column link
        ...
        */
        ...
        /*
        @tab Lower Columns
        @section lower left column style
        @tip Set the styling for your email's left column text. Choose a size and color that is easy to read.
        */
        ...
        /*
        @tab Lower Columns
        @section lower left column link
        @tip Set the styling for your email's left column links. Choose a color that helps them stand out from your text.
        */
        ...
        /*
        @tab Lower Columns
        @section lower right column style
        @tip Set the styling for your email's right column text. Choose a size and color that is easy to read.
        */
        ...
        /*
        @tab Lower Columns
        @section lower right column link
        @tip Set the styling for your email's right column links. Choose a color that helps them stand out from your text.
        */
        ...
        */
        ...
        @media screen and (min-width:768px){
            ...
            */
            ...
            /*
            @tab Mobile Styles
            @section Left Three Column Text
            ...
            */
            ...
            /*
            @tab Mobile Styles
            @section Center Three Column Text
            ...
            */
            ...
            /*
            @tab Mobile Styles
            @section Right Three Column Text
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                                    ...
                                    <td valign="top" class="preheaderContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock">
                                            ...
                                            <tr>
                                                <td valign="top" class="mcnTextBlockInner">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="596" class="mcnTextContentContainer">
                                                        <tbody><tr>

                                                            <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">

                                                                <table><tbody><tr><td><img align="none" height="64" src="https://gallery.mailchimp.com/6aaf14738b3973934309cb78e/images/8615d84d-987c-4f73-a1c3-29e5f67d0d91.png" style="width: 189px; height: 64px; margin: 0px;" width="189"></td>
                                                                        <td style="font-family:arial,helvetica neue,helvetica,sans-serif;font-size:24pt;color:#999999;">SERVO ventilators win</td></tr></tbody></table>
                                                            </td>
                                                        </tr>
                                                        </tbody></table>
                    ...
                    <tr>
                        <td align="center" valign="top" id="templateHeader">
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top" class="headerContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnImageBlock">
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                                                        <tbody><tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0;">
                                                                ...
                                                                <img align="left" alt="" src="https://gallery.mailchimp.com/6aaf14738b3973934309cb78e/images/312d479c-f0c9-42b4-a400-48b65680c3a9.png" width="600" style="max-width:980px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                    ...
                                    <td valign="top" class="bodyContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="596" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                ...
                                                                <h1 class="null">We Welcome you to Arab Health 2015</h1>

                                                                <h4 class="null"><span style="color:#2ab2e5"><span style="font-size:12px">2015.06.02 | Exhibition</span></span></h4>
                                                                For more than 175 years, Maquet has been a pioneer in medical excellence for hospitals and clinicians. This year, we will be&nbsp;presenting the latest in medical technologies in conjunction with our partner companies ArjoHuntleigh and Getinge Infection&nbsp;Control.<br>
                                                                <br>
                                                                <a href="http://getingegroup.com" target="_blank">Read More ⟶</a>
                                            ...
                                            <tr>
                                                <td valign="top" class="mcnBoxedTextBlockInner">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="596" class="mcnBoxedTextContentContainer">
                                                        <tbody><tr>

                                                            <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">

                                                                <table border="0" cellpadding="18" cellspacing="0" class="mcnTextContentContainer" width="100%" style="border: 1px none #999999;background-color: #FFFFFF;">
                                                                    <tbody><tr>
                                                                        <td valign="top" class="mcnTextContent">
                                                                            <style type="text/css">.eor tr:nth-child(even) td {
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnCaptionRightContentOuter" width="100%">
                                                        <tbody><tr>
                                                            <td valign="top" class="mcnCaptionRightContentInner" style="padding:0 9px ;">
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionRightImageContentContainer">
                                                                    <tbody><tr>
                                                                        <td class="mcnCaptionRightImageContent" valign="top">
                                                                            ...
                                                                            <img alt="" src="https://gallery.mailchimp.com/6aaf14738b3973934309cb78e/images/fcbc22a0-74db-4b88-ac9d-d3ef7be0b3c0.jpg" width="262" style="max-width:459px;" class="mcnImage">
                                                                ...
                                                                <table class="mcnCaptionRightTextContentContainer" align="right" border="0" cellpadding="0" cellspacing="0" width="262">
                                                                    <tbody><tr>
                                                                        <td valign="top" class="mcnTextContent">
                                                                            Completely synergize resource<br>
                                                                            <br>
                                                                            2015.09.18 | Solution<br>
                                            ...
                                            <tr>
                                                <td valign="top" class="mcnBoxedTextBlockInner">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="280" class="mcnBoxedTextContentContainer">
                                                        <tbody><tr>
                                                    ...
                                                    <table align="right" border="0" cellpadding="0" cellspacing="0" width="280" class="mcnBoxedTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td class="mcnBoxedTextContentColumn" style="padding-top:9px; padding-right:18px; padding-bottom:9px; padding-left:0;">
                                                                ...
                                                                <table border="0" cellpadding="18" cellspacing="0" class="mcnTextContentContainer" width="100%" style="border: 1px none #999999;background-color: #FFFFFF;">
                                                                    <tbody><tr>
                                                                        <td valign="top" class="mcnTextContent">
                                                                            <h2 class="null">Completely synergize resource</h2>
                                                                            <br>
                                                                            Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after&nbsp;<br>
                                                                            installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.<br>
                                                                            <br>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="280" class="mcnBoxedTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td class="mcnBoxedTextContentColumn" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                                                                ...
                                                                <table border="0" cellpadding="18" cellspacing="0" class="mcnTextContentContainer" width="100%" style="border: 1px none #ffffff;background-color: #f4f4f5;">
                                                                    <tbody><tr>
                                                                        <td valign="top" class="mcnTextContent">
                                                                            <h2 class="null">INSIGHT – The Clinical Logistics Solution</h2>

                                                                            <h4 class="null">2015.06.02 | Exhibition</h4>
                                                                            In addition to our innovative solutions for the operating theater, hybrid OR, intensive care unit and patient&nbsp;<br>
                                                                            transport, we are pleased to introduce a new software solution that ties together all aspects of patient care: “INSIGHT.“<br>
                                                                            <br>
                                                                            This IT tool sets the standards for the future. It tracks each patient from admission to discharge, facilitating care and streamlining&nbsp;<br>
                                                                            interdepartmental workflows&nbsp;<br>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top" id="templateUpperColumns">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="text-align:center; display:inline-block;" valign="top">
                                        ...
                                        <div style="display:inline-block; vertical-align:top; width:197px;" class="upperColumnWidth">
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="threeColumnsContainer">
                                                <tr>
                                                    <td valign="top" class="upperLeftColumnContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCaptionBlock">
                                                            <tbody class="mcnCaptionBlockOuter">
                                                            <tr>
                                                                <td class="mcnCaptionBlockInner" valign="top" style="padding:9px;">
                                                                    ...
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="false">
                                                                        <tbody><tr>
                                                                            <td class="mcnCaptionBottomImageContent" align="left" valign="top" style="padding:0 9px 9px 9px;">
                                                                                ...
                                                                                <img alt="" src="https://gallery.mailchimp.com/6aaf14738b3973934309cb78e/images/1dcd2955-5b2c-49ce-9faf-260746ae64d8.png" width="161" style="max-width:300px;" class="mcnImage">
                                                                        ...
                                                                        <tr>
                                                                            <td class="mcnTextContent" valign="top" style="padding:0 9px 0 9px;" width="161">
                                                                                ...
                                                                                <h4 class="null">2015.06.02 | Exhibition</h4>
                                                                                Experience how INSIGHT can improve workflow efficiency and the quality of patient care at your hospital. Come to booth no. S2G30 to learn more and exchange ideas at our bistro while you enjoy coffees and snacks.<br>
                                                                                <br>
                                                                                Read more
                                                                            </td>
                                                                        </tr>
                                        ...
                                        <div style="display:inline-block; vertical-align:top; width:197px;" class="upperColumnWidth">
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="threeColumnsContainer">
                                                <tr>
                                                    <td valign="top" class="upperCenterColumnContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCaptionBlock">
                                                            <tbody class="mcnCaptionBlockOuter">
                                                            <tr>
                                                                <td class="mcnCaptionBlockInner" valign="top" style="padding:9px;">
                                        ...
                                        <div style="display:inline-block; vertical-align:top; width:197px;" class="upperColumnWidth">
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="threeColumnsContainer">
                                                <tr>
                                                    <td align="center" valign="top" class="upperRightColumnContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCaptionBlock">
                                                            <tbody class="mcnCaptionBlockOuter">
                                                            <tr>
                                                                <td class="mcnCaptionBlockInner" valign="top" style="padding:9px;">

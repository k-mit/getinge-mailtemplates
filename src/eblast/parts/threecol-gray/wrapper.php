        ...
        <tr>
            <td align="left" style="text-align:center; display:inline-block; padding-left: 9px" valign="top">
                ...
                <table align="left" border="0" cellspacing="0" cellpadding="0" style="width:582px;" width="582">
                    <tr>
                        <td align="left" valign="top" style="width:176px;" width="176">
                <![endif]-->
                <?php $tc3 = 1; include("column33.php"); ?>
                <!--[if gte mso 9]>
                </td>
                <td align="center" valign="top" style="width:176px;" width="176">
                <![endif]-->
                <?php $tc3 = 2; include("column33.php"); ?>
                <!--[if gte mso 9]>
                </td>
                <td align="right" valign="top" style="width:176px;" width="176">
                <![endif]-->
